...
FROM build_examples AS example_client_pub_protobuf
CMD ["examples/build/Release/example_client_pub_protobuf"]

FROM build_examples AS example_server_client_pub
CMD ["examples/build/Release/example_server_client_pub"]